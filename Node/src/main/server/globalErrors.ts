const ERROR_CODES = {
  ...
  PERMISSION: {
    NO: {
      ...
      // TODO implement this error on frontend
      TRIGGER: { ERROR_CODE_FROM_ERROR_CODES: 'ER_PERMISSION_NO_TRIGGER' },
    },
    INVALID: {
  ...
  FAMILY: {
    LIMIT: {
      ...
      // TODO implement this error on frontend
      TRIGGER_TOO_LOW: { ERROR_CODE_FROM_ERROR_CODES: 'ER_FAMILY_LIMIT_TRIGGER_TOO_LOW' },
    ...
    DELETED: {
      ...
      // TODO implement this error on frontend
      TRIGGER: { ERROR_CODE_FROM_ERROR_CODES: 'ER_FAMILY_DELETED_TRIGGER' },
    },
    JOIN: {
