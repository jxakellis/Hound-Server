...
const previousUsersColumnsWithPUPrefix = `
pu.userId,
pu.userIdentifier,
...
const previousUsersColumnsWithoutPrefix = previousUsersColumnsWithPUPrefix.replace(prefix, '');
...
export {
  PreviousUsersRow,
  previousUsersColumnsWithPUPrefix,
