...
const previousFamilyMembersColumnsWithPFMPrefix = `
pfm.familyId,
pfm.userId,
...
const previousFamilyMembersColumnsWithoutPrefix = previousFamilyMembersColumnsWithPFMPrefix.replace(prefix, '');
...
export {
  ...
  previousFamilyMembersColumnsWithPFMPrefix,
